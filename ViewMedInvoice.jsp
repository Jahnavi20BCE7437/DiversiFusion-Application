<%-- 
    Document   : ViewMedInvoice
    Created on : 14 Oct, 2023, 9:37:08 PM
    Author     : GKV
--%>
...
try{
 FileOutputStream fos = new FileOutputStream("C:\\myproject\\"+name+"_Medicine.pdf");
 ...
 PdfPTable table = new PdfPTable(4);
  ...
  PdfPCell cell3 = new PdfPCell(new Paragraph("Noof Medicine"));
  ...
  ResultSet rr=Queries.getExecuteQuery("select * from bookmedicine where uid='"+id+"'and status!='Cancelled'");
  ...
  PdfPCell cell5 = new PdfPCell(new Paragraph(rr.getString("mname")));
...
FileInputStream fis=new FileInputStream("C:\\myproject\\"+name+"_Medicine.pdf");
