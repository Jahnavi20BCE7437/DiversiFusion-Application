<%-- 
    Document   : AddElectrical
    Created on : 27 Oct, 2023, 10:16:29 AM
    Author     : GKV
--%>
              ...
              <div class="d-flex mr-auto flex-column flex-lg-row align-items-center">
                <ul class="navbar-nav  ">
                  <li class="nav-item ">
                   ...
                   <li class="nav-item active">
                    <a class="nav-link" href="EAddMaterial.jsp">Add Material</a>
                  </li>
                   <li class="nav-item active">
                    <a class="nav-link" href="EViewMaterials.jsp"> View Materials</a>
                  </li>
                  <li class="nav-item active">
