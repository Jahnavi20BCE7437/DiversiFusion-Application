<%-- 
    Document   : UserHome
    Created on : 14 Oct, 2023, 11:32:04 AM
    Author     : GKV
--%>
      ...
      <div class="row" style="border:10px solid black;">
        <div class="col-md-7">
          ...
          <div class="form_container" style="height:350px;width:430px;">
           ...
           <h3 style="color:gold">Search Medicine</h3>
          </div>
            </a>
        </div>
          <a href="SearchMaterials.jsp">
        <div class="col-md-5" style="height:350px;">
          
            <img src="img/construction.jpg" alt="" style="height:265px;">
        <h3 style="color:gold">Search Materials</h3>
        </div>
          </a>
          <a href="SearchAppliances.jsp">
        <div class="col-md-5" style="height:350px;">
          
            <img src="img/electrical.jpg" alt="" style="height:265px;">
        <h3 style="color:gold">Search Appliances</h3>
        </div>
          </a>
