<%-- 
    Document   : EAddMaterial
    Created on : 27 Oct, 2023, 10:22:40 AM
    Author     : GKV
--%>
      ...
      <div class="row">
        <div class="col-md-7">
          <div class="form_container">
            <form action="AddEItemAction.jsp" method="post">
              <div>
                <select name="category"  required="">
                    <option></option>
             <%try{
                 ResultSet r=Queries.getExecuteQuery("select * from ecategory");
                 while(r.next()){
                     %>
